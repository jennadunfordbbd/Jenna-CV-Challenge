...
const experiencePage =
  "<section class='experienceSection'><article><h3>My Experience</h3><ol class='experienceList'><li>High School Years</li><ul class='experienceList'><li class='experienceList'>I worked as a library monitor and was on the Learner Management Team in my matric year where myself and other nominated students helped to organize events and fundraising projects within the school.</li><li class='experienceList'>During my grade 11 year I worked as a table runner in a restaurant that was called Chez Nous, which has unfortunately since been closed.</li><li>For a week I helped to manage a second hand bookstore.</li></ul><li>University Years</li><ul class='experienceList'><li> I've done tutoring for Information Technology for the company TeachMe2. My responsibilities included preparing lessons and aiding my students in their difficulties.</li><li>I worked on the POC of the MVP for the All4SA project at BBD</li></ul></ol></article></section>";
